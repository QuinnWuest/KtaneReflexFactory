...
public class FakeStatusLight : MonoBehaviour
{
    ...
    protected IEnumerator GetStatusLight(Transform statusLightParent)
    {
        for (var i = 0; i < 60; i++)
        {
            var off = FindDeepChild(statusLightParent, "Component_LED_OFF");
            var pass = FindDeepChild(statusLightParent, "Component_LED_PASS");
            var fail = FindDeepChild(statusLightParent, "Component_LED_STRIKE");
